...
export default function LoginPage() {
    return (
        <main className="w-full flex-1 min-h-[100dvh] bg-background-light dark:bg-background-dark flex items-center justify-center p-4 overflow-hidden relative">
            ...
            <div className="w-full max-w-md bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl overflow-hidden relative z-10">
                <div className="p-8 text-center border-b border-slate-100 dark:border-slate-800 bg-white/50 dark:bg-slate-800/20">
                    ...
                    <h1 className="text-2xl font-semibold text-slate-900 dark:text-white mb-1">CrewForce</h1>
